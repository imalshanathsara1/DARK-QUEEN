    ...
    switch (inputCMD) {
      ...
      case "toimage":
        ...
        exec(`ffmpeg -i ${mediaMess} ${ran}`, (err) => {
          ...
          Atlas.sendMessage(
            m.from,
            { image: buffer, caption: `_Converted by:_  *© [ᴅᴇᴠᴇʟᴏᴘᴇʀ ʙʏ ᴍʀ ᴘᴀꜱɪɴᴅᴜ]*\n` },
            { quoted: m }
          );
          fs.unlinkSync(ran);
        });
      ...
      case "tomp4":
        ...
        await Atlas.sendMessage(
          m.from,
          {
            ...
            caption: `_Converted by:_  *© [ᴅᴇᴠᴇʟᴏᴘᴇʀ ʙʏ ᴍʀ ᴘᴀꜱɪɴᴅᴜ]*\n`,
          },
          { quoted: m }
        );
      ...
      case "tomp3":
        ...
        Atlas.sendMessage(
          m.from,
          {
            document: audio,
            mimetype: "audio/mpeg",
            fileName: `Converted By © [ᴅᴇᴠᴇʟᴏᴘᴇʀ ʙʏ ᴍʀ ᴘᴀꜱɪɴᴅᴜ] ${m.id}.mp3`,
          },
          { quoted: m }
        );
          ...
          try {
            ...
            setTimeout(async () => {
              ...
              Atlas.sendMessage(
                ...
                {
                  document: pdf,
                  fileName: `Converted By © [ᴅᴇᴠᴇʟᴏᴘᴇʀ ʙʏ ᴍʀ ᴘᴀꜱɪɴᴅᴜ].pdf`,
                },
                { quoted: m }
              );
